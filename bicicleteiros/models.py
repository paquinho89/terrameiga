...
class country_information_model(models.Model):
    ...
    #Fao que sea un charfield para meterlle as comas nos millós, nos millares e nas centenas
    surface = models.CharField(max_length=33, blank=True, null=True)
    population = models.CharField(max_length=33, blank=True, null=True)
    population_density = models.CharField(max_length=33, blank=True, null=True)
    rent_per_capita = models.CharField(max_length=33, blank=True, null=True)
